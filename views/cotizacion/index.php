<?php
    ...
    global $_action;
    $id = $_REQUEST["id"];
    $_group = (($_REQUEST["group"]=="")?"estado_cotizacion":$_REQUEST["group"] );    
    ...
    $sql ="
            ...
            ".(($_REQUEST["search"]!="")?" and cotizacion like '%".$_REQUEST["search"]."%'":"")."
...
<div class="row">
    ...
    <?php if( $_action == "" ){?>
    	...
    	<form name="form1" id="form1" method="post"  action="index.php">
    		<div class="form-row">
        		<input type="hidden" name="view" id="view" value="cotizacion" />
...
<script>
    ...
    $('#clear').click(function() {
        location.href='index.php?view=cotizacion&action=kanban';
    });
</script>