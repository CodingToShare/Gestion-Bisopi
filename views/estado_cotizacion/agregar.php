<?php
    global $db;
    $objeto = $db->selectObject("estado_cotizacion", "id_estado_cotizacion= '".$id."'" );    
?>
<div class="p-3">
<div class="h3" ><?php echo (($id!="")?"Editar":"Crear");?> Estado Leads</div>
<div class="border border-secondary rounded px-3 pt-3">
<form name="form1" id="form1" method="post" onsubmit="return false;">
  <div class="form-row">
  	<div class="form-group col-md-12">
    	<label for="estado_cotizacion">Estado Lead <span class="text-danger" style='font-weight:bold'>*</span></label>
    	<input type="text" class="form-control" id="estado_cotizacion" name="estado_cotizacion" value="<?php echo $objeto->estado_cotizacion;?>">
  	</div>
  </div>
	<div class="form-row">
	...
	<div class="form-group">
		<input type="hidden" id="id_estado_cotizacion" name="id_estado_cotizacion" value="<?php echo $objeto->id_estado_cotizacion;?>">
...
<script>
    ...
    $( "#save" ).click(function() {
      	xajax_guardar( xajax.getFormValues( this.form , true ) , 'estado_cotizacion' , <?php echo $json_fields;?> );
    });
